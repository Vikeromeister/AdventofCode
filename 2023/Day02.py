input = """Game 1: 1 green, 2 blue; 15 blue, 12 red, 2 green; 4 red, 6 blue; 10 blue, 8 red; 3 red, 12 blue; 1 green, 12 red, 8 blue
...
Game 100: 1 blue, 1 red, 1 green; 8 blue, 1 green; 1 green, 7 blue, 1 red; 1 green, 4 blue, 1 red; 1 green, 3 blue""".splitlines()
...
for id, line in enumerate(input):
    ...
    for round in rounds:
        ...
        for ball in balls:
            ...
            number = int(number)
            if color == "red":
                minred = max(number, minred)
            if color == "green":
                mingreen = max(number, mingreen)
            if color == "blue":
                minblue = max(number, minblue)
